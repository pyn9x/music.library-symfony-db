 ...
 */
final class Version20220603213642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `group` ADD CONSTRAINT FK_6DC044C54296D31F FOREIGN KEY (genre_id) REFERENCES genre (id)');
